...
class HungarianMatcher(nn.Module):
    ...
    def __init__(
        ...
        self.nwd_C = nwd_C
        assert cost_class != 0 or cost_bbox != 0 or cost_giou != 0 or cost_nwd != 0, "all costs can't be 0"
...
def build_matcher(args):
    nwd_kwargs = {}
    if getattr(args, "set_cost_nwd", 0) > 0:
        nwd_kwargs["cost_nwd"] = args.set_cost_nwd
        nwd_kwargs["nwd_C"] = getattr(args, "nwd_C", 0.5)
